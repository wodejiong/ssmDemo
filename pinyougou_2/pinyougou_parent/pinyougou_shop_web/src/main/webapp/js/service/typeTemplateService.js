...
app.service('typeTemplateService',function($http){
	...
	this.findBrandList=function () {
        return $http.get('../typeTemplate/findBrandList.do');
    }

    this.findSpecList=function () {
		return  $http.get('../typeTemplate/findSpecList.do');
    }

    this.findList=function(){
        return $http.get('../typeTemplate/findList.do');
    }

    this.findResult=function (id) {
		return $http.get("../goods/findResult.do?id="+id)
    }
});
