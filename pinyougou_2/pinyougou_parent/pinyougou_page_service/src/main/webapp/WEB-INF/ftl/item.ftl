...
</a></dd>						<#list spec.attributeValue as item>
								<dd><a href="javascript:;" ng-click="selectSpec('${spec.attributeName}','${item}')" class="{{isSelected('${spec.attributeName}','${item}')?'selected':''}}">${item}<span title="点击取消选择">&nbsp;</span></a></dd>
							</#list>
							</dl>
							</#list>
							...
							<div class="fl title">
								<div class="control-group">
									<div class="controls">
										...
										<a href="javascript:void(0)" class="increment plus" ng-click="calNum(1)">+</a>
										<a href="javascript:void(0)" class="increment mins" ng-click="calNum(-1)">-</a>
									</div>
								</div>
							</div>
							<div class="fl">
