...
public class SeckillOrderController {
	...
	/**
	 * 点击立即抢购生成订单,将订单保存到redis中
	 * @param seckillGoodId 秒杀商品id
	 * @return
	 */
	@RequestMapping("/saveScekillOrderToRedis")
	public Result saveScekillOrderToRedis(Long seckillGoodId) {
		try {
			String username = SecurityContextHolder.getContext().getAuthentication().getName();
			if ("anonymous".equals(username)) {
				return new Result(false, "您还未登录,请登录");
			}
			seckillOrderService.saveScekillOrderToRedis(seckillGoodId,username);
