				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="删除选中" onclick="deleteSelected()">
											<i class="fa fa-refresh"></i> 删除选中
										</button>
									</div>
								</div>
							</div>
							...
							<!--数据列表-->
							<form action="${pageContext.request.contextPath}/permission/deleteSelected.do" id="p_Form">
							<table id="dataList"
									...
									<c:forEach items="${permissions}" var="permission">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/permission/deleteById.do?id=${permission.id}" class="btn bg-olive btn-xs">删除</a>
												<a href="${pageContext.request.contextPath}/permission/updateById.do?id=${permission.id}" class="btn bg-olive btn-xs">修改</a>
